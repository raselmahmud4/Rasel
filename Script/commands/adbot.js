...
module.exports.run = async({api,event,args}) => {
  ...
  {body:`———»ADMIN BOT«———\n❯ Name: 𝐑𝐚𝐬𝐞𝐥 𝐌𝐚𝐡𝐦𝐮𝐝\n❯ Facebook: https://www.facebook.com/iiii.482394\n❯ Thanks for using ${global.config.BOTNAME} 𝐀𝐈`,
    ...
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(encodeURI(`https://graph.facebook.com/100024220812646/picture?height=720&width=720&access_token=6628568379|c1e620fa708a1d5696fb991c1bde5662`)).pipe(
